...
export default function BoardPostContent() {
  ...
  const handleEdit = async () => {
    ...
    const response = await fetch(`${API.API_BASE_URL}/private/postcontent/authorcheck`, {
      method: 'POST',
      credentials: 'include',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
    ...
    if(result.AuthorChecker) {
      navigate(`/privateEdit/${boardId}/${postId}`);
    } else {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`${API.API_BASE_URL}/private/post/delete`, {
        method: 'POST',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API.API_BASE_URL}/private/comment/create`, {
        method: 'POST',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleCommentDelete = async (commentId) => {
    ...
    try {
      const response = await fetch(`${API.API_BASE_URL}/private/comment/delete`, {
        method: 'POST',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
